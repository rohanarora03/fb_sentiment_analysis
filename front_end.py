...
class FlaskIgnite:
    ...
    def result():
        ...
        url = 'https://graph.facebook.com/' + query[
            3] + '?&access_token=EAAB4RjO6UKwBAHDrR1cvIrQV3cJsi5jn3Krp5bjHpf0guiSpiGcFUYzXByZC8rUUKqHetaJk4tIrFqsQlsc5xX0rw4jMD7NDnhUHF6jNbFHc10CyRRnF4faqLq7ItxH2yX0OZCd4OBfKzU9MhGTjU6MKMTLGKvQZAtUTEnIrgZDZD'
        # print(url)
        r = requests.get(url)
        dict = r.json()
